...
export function TechnologySection({ articles, onReadMore }: TechnologySectionProps) {
  ...
  return (
    <div className="mt-12">
      <div id="technology" className="py-4 border-b-2 border-deep-blue dark:border-deep-blue">
        <div className="flex items-center mb-3">
          <div className="w-4 h-1 mr-3" style={{backgroundColor: '#000057'}}></div>
          <h2 className="text-xl font-black uppercase tracking-wide text-left" style={{color: '#000057'}}>Technology</h2>
        </div>
      </div>
